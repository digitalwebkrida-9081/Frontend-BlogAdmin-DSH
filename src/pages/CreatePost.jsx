...
const CreatePost = () => {
  ...
  const handleSlugAutofill = (title) => {
    return title
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, "-")
      .replace(/(^-|-$)+/g, "");
        ...
        {formData.showCta && (
          ...
          >
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              placeholder="e.g. Need Custom Data? Get high-quality scraped data tailored to your business needs."
            ></textarea>
